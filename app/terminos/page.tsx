    ...
    <main className="min-h-screen bg-[#0a0a0a] py-24 px-6">
      <div className="max-w-[640px] mx-auto">
        ...
        <div className="space-y-8 text-sm text-zinc-400 leading-relaxed">
          <section>
            <h2 className="text-sm font-semibold text-zinc-50 mb-2">1. Servicios</h2>
          ...
          <section>
            <h2 className="text-sm font-semibold text-zinc-50 mb-2">2. Pagos y entregables</h2>
          ...
          <section>
            <h2 className="text-sm font-semibold text-zinc-50 mb-2">3. Revisiones</h2>
          ...
          <section>
            <h2 className="text-sm font-semibold text-zinc-50 mb-2">4. Propiedad intelectual</h2>
          ...
          <section>
            <h2 className="text-sm font-semibold text-zinc-50 mb-2">5. Limitación de responsabilidad</h2>
